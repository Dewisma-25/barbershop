            ...
            <div class="booking-wrapper">
                ...
                <div class="left-column">
                    ...
                    <div class="service-section">
                        ...
                        @if($discount)
                        <div style="background: linear-gradient(135deg, #a7b27a, #8a9a5b);
                border-radius: 10px; padding: 12px 16px;
                color: white; margin-bottom: 12px;">
                            🎉 <strong>{{ $discount->persen }}% Today's Discount!</strong>
                            <div style="font-size:0.8rem; opacity:0.85;">{{ $discount->nama }}</div>
                        </div>
                        @endif
