...
@section('content')
    ...
    <div class="breadcrumb-panel">
        <i style="color: black;" class="bi bi-house-door"></i> Panel / Data Barber <span style="font-weight:500; color:black;">User data</span>
    </div>
    <div class="page-title">Data Barber</div>
